...
export default function AddSpeciesDialog({ species, userId, profiles }: { species: Species; userId: string; profiles: Profiles }) {
  ...
  const onSubmit = async (input: FormData) => {
    ...
    return toast({
      title: "This species has been Edited!",
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-h-screen overflow-y-auto sm:max-w-[600px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Edit this species here. Click &quot;Save Edits&quot; below when you&apos;re done.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder={species.scientific_name ?? "Scientific Name"} {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
                ...
                render={({ field }) => {
                  ...
                  return (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input value={value ?? ""} placeholder= {species.common_name ?? "Common Name"} {...rest} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  );
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <Select onValueChange={(value) => field.onChange(kingdoms.parse(value))} value={field.value}>
                      <FormControl>
                        <SelectTrigger>
                          <SelectValue placeholder={species.kingdom ?? "Select a Kingdom"} />
                        </SelectTrigger>
                      </FormControl>
                      <SelectContent>
                        <SelectGroup>
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        ...
                        <Input
                          type="number"
                          value={value ?? ""}
                          placeholder={"" + species.total_population} {...rest}
                  ...
                  return (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          value={value ?? ""}
                          placeholder={species.image ?? "Insert Link Here"} {...rest}
                        />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  ...
                  return (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea
                          value={value ?? ""}
                          placeholder={species.description ?? "Add a Description"} {...rest}
                        />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
